...
package ca.skynetcloud.cascadesorcery.world.structure;
...
import ca.skynetcloud.cascadesorcery.world.dimension.ShadowRealmDimension;
import ca.skynetcloud.cascadesorcery.CascadeSorceryModElements;

@CascadeSorceryModElements.ModElement.Tag
public class ShadowtreeStructure extends CascadeSorceryModElements.ModElement {
	public ShadowtreeStructure(CascadeSorceryModElements instance) {
		super(instance, 41);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 1500) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("cascade_sorcery", "shadow_tree"));
						if (template == null)
							return false;
