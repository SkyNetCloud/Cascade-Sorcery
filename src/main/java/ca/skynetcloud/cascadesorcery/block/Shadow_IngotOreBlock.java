...
public class Shadow_IngotOreBlock extends CascadeSorceryModElements.ModElement {
	@ObjectHolder("cascade_sorcery:shadow_ingot_ore")
	public static final Block block = null;
	public Shadow_IngotOreBlock(CascadeSorceryModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("shadow_ingot_ore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("shadow_ingot_ore", "shadow_ingot_ore", blockAt -> {
