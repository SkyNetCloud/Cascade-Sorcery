...
import net.mcreator.cascadesorcery.item.Shadow_armorArmorItem;
...
public class MergerProcedureProcedure extends CascadeSorceryModElements.ModElement {
	public MergerProcedureProcedure(CascadeSorceryModElements instance) {
		super(instance, 1);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure MergerProcedure!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure MergerProcedure!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure MergerProcedure!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure MergerProcedure!");
			return;
		}
