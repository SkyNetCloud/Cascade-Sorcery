...
public class CascadeSorceryModElements {
	...
	public CascadeSorceryModElements() {
		...
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == CascadeSorceryModElements.ModElement.class)
						elements.add((CascadeSorceryModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(CascadeSorceryModElements.ModElement::initElements);
		MinecraftForge.EVENT_BUS.register(new CascadeSorceryModVariables(this));
	}
	...
	public <T> void addNetworkMessage(Class<T> messageType, BiConsumer<T, PacketBuffer> encoder, Function<PacketBuffer, T> decoder,
		...
		CascadeSorceryMod.PACKET_HANDLER.registerMessage(messageID, messageType, encoder, decoder, messageConsumer);
		messageID++;
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final CascadeSorceryModElements elements;
		protected final int sortid;
		public ModElement(CascadeSorceryModElements elements, int sortid) {
