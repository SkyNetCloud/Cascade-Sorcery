...
public class Mark1MergerProcedureProcedure extends CascadeSorceryModElements.ModElement {
	public Mark1MergerProcedureProcedure(CascadeSorceryModElements instance) {
		super(instance, 49);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure Mark1MergerProcedure!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure Mark1MergerProcedure!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure Mark1MergerProcedure!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Mark1MergerProcedure!");
			return;
		}
		...
		if ((((new Object() {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem() == new ItemStack(Mark1MergerBlock.block, (int) (1)).getItem())
				&& ((new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
						TileEntity _ent = world.getTileEntity(pos);
			...
			}
			{
				...
				if (_ent != null) {
					...
					final ItemStack _setstack = new ItemStack(MergerTableBlockBlock.block, (int) (1));
